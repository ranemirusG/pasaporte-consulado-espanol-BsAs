...
4. `Actions` >
   - `Start a program`
   - `Program/script`: full path al python executable
   - `Arguments`: nombre del script de python (en este caso: `check_citas_pasaporte.py`)
   - `Start in`: full path al directorio en donde esta dicho script
